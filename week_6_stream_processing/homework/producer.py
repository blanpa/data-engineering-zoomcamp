...
counter = 0
filename = "green/green_tripdata_2019-01.csv.gz"
filename = "fhv/fhv_tripdata_2019-01.csv.gz"
filepath = f"https://github.com/DataTalksClub/nyc-tlc-data/releases/download/{filename}"
